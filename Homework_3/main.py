...
def train_eval(
    learning_algo: BaseLearningAlgorithm, x_train, y_train, x_val, y_val, x_test, y_test
):
...
if __name__ == "__main__":
    ...
    x_trainval, x_test, y_trainval, y_test = train_test_split(
        x, y_raw, test_size=0.10, random_state=42
    )
    ...
    learning_algo = DeepNeuralNetworkLearningAlgorithm(
        sizes=[784, 128, 64, 10], epochs=1, l_rate=0.001, activation_function="sigmoid"
    )
